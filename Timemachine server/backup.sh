...
function install() {
  ...
  whiptail --title "${title_of_installer}" --msgbox "\n\nNext we will ask for a username and a password. You will need to use these credentials to add the AFP Server to your mac. So choose something logic." ${r} ${c}
  ask_username true
  ask_password
...
#   fi
#
#   whiptail --title "${title_of_installer}" --msgbox "\n\nThis installer will create a new user/AFP drive." ${r} ${c}
#   whiptail --title "${title_of_installer}" --msgbox "\n\nNext we will ask for a username and a password. You will need to use these credentials to add the AFP Server to your mac. So choose something logic." ${r} ${c}
#   ask_username true
#   ask_password
#
